...
\caption*{\textbf{Graphical Abstract.} ChEMBL-PDB Linker integrates bioactivity data from ChEMBL with 3D structures from PDB through a two-tier linking strategy. The critical pair validation step ensures that both the target protein and ligand are present in the same crystal structure, eliminating 99\% of false positives and producing a curated dataset of 98,500 validated protein-ligand pairs.}
\end{figure}
\vspace{1em}
